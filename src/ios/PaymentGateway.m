/********* PaymentGateway.m Cordova Plugin Implementation *******/

#import <Cordova/CDV.h>

@interface PaymentGateway : CDVPlugin {
...
- (void)add:(CDVInvokedUrlCommand*)command;
{
    ...
    if(param1 >=0 && param2 >=0)
    {
        ...
        pluginResult = luginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString:total];
    }
    else
    {
